    ...
    return (
        <Layout layoutNoOverflow footerHide>
            <Description
                ...
                content="Tesseract is the one stop marketplace for discovering state of the art Generative AI models. Join the millions of creators, collectors, and curators who are on this journey with you."
            >
                {buy && (
                    <>
                        <Details
