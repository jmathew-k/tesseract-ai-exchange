...
const Information = ({}: InformationProps) => {
    const [email, setEmail] = useState<string>("hello@tesseractxyz.com");
    const [name, setName] = useState<string>("Dash");
    const [bio, setBio] = useState<string>("");
    const [site, setSite] = useState<string>("https://tesseractxyz.com");
    const [twitter, setTwitter] = useState<string>("https://twitter.com/tesseract_xyz");
    const [facebook, setFacebook] = useState<string>(
        "https://facebook.com/tesseractxyz"
    );
